    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" @click="projetStore.toggleProjectModal()" class="btn-close btn-close-white"></button>
        </div>
            ...
            <div class="row mx-0">
              ...
              <div class="col-xl-6 mb-2">
                ...
                <input type="email" class="form-control"
                  :class="{ 'is-invalid': errors.value.client_name && errors.value.client_name.$invalid }" id="full-name"
                  v-model="projetModel.client_name">
            ...
            <div class="row mx-0">
              <div class="col-xl-6 mb-2">
                ...
                <input type="date" class="form-control"
                  :class="{ 'is-invalid': errors.value.start_date && errors.value.start_date.$invalid }" id="full-name"
                  v-model="projetModel.start_date" />
...
const addProjet = async () => {
  ...
  if (!v$.value.$invalid) {
    ...
    const projet = await axios.post("/audits", projetModel.value).then(res => {
      ...
      projetStore.toggleProjectModal();
      toast.success('Projet has been added');
    }).catch((error) => {
      toast.error(error);
    })
  }
